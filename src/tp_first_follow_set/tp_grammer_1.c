...
TP_GRAMMER** tp_make_grammer_1(TP_SYMBOL_TABLE* symbol_table, rsize_t* grammer_num)
{
    // Program -> Statement ProgramTmp1
    // ProgramTmp1 -> Statement ProgramTmp1 | ε
    TP_GRAMMER* program = MAKE_GRAMMER_ELEMENT(
    ...
    TP_GRAMMER* program_tmp1 = MAKE_GRAMMER_ELEMENT(
    ...
    // StatementTmp1 -> Type | ε
    // Type -> int
    TP_GRAMMER* statement = MAKE_GRAMMER_ELEMENT(
    ...
    TP_GRAMMER* statement_tmp1 = MAKE_GRAMMER_ELEMENT(
    ...
    TP_GRAMMER* type = MAKE_GRAMMER_ELEMENT(
    ...
    // ExpressionTmp1 -> ExpressionTmp2 Term ExpressionTmp1 | ε
    // ExpressionTmp2 -> '+' | '-'
    TP_GRAMMER* expression = MAKE_GRAMMER_ELEMENT(
    ...
    TP_GRAMMER* expression_tmp1 = MAKE_GRAMMER_ELEMENT(
    ...
    TP_GRAMMER* expression_tmp2 = MAKE_GRAMMER_ELEMENT(
    ...
    // TermTmp1 -> TermTmp2 Factor TermTmp1 | ε
    // TermTmp2 -> '*' | '/'
    TP_GRAMMER* term = MAKE_GRAMMER_ELEMENT(
    ...
    TP_GRAMMER* term_tmp1 = MAKE_GRAMMER_ELEMENT(
    ...
    TP_GRAMMER* term_tmp2 = MAKE_GRAMMER_ELEMENT(
    ...
    // FactorTmp1 -> '+' | '-' | ε
    // FactorTmp2 -> variable | constant
    TP_GRAMMER* factor = MAKE_GRAMMER_ELEMENT(
    ...
    TP_GRAMMER* factor_tmp1 = MAKE_GRAMMER_ELEMENT(
    ...
    TP_GRAMMER* factor_tmp2 = MAKE_GRAMMER_ELEMENT(
    ...
    return MAKE_GRAMMER(symbol_table, grammer_num, 
